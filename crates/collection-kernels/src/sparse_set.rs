...
mod tests {
    ...
    #[test]
    fn sparse_map_insert_get_replace_and_remove_preserve_values() {
    ...
    #[test]
    fn sparse_map_swap_remove_repairs_moved_entry_lookup() {
        let mut map = SparseMap::new();
        for key in [10, 20, 30, 40] {
    ...
    #[test]
    fn sparse_map_mutable_iteration_updates_dense_values_without_losing_keys() {
        let mut map = SparseMap::new();
    ...
    #[test]
    fn sparse_map_supports_sparse_large_keys_without_dense_value_padding() {
    ...
    #[test]
    fn sparse_map_mixed_operations_match_a_standard_map_oracle() {
        let operations = [
            (true, 5, 50),
            (true, 1, 10),
            (true, 9, 90),
    ...
    #[test]
    fn sparse_map_clear_preserves_reusable_sparse_storage_semantics() {
        let mut map = SparseMap::new();
